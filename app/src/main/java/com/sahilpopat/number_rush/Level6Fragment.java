...
public class Level6Fragment extends Fragment {
    ...
    public Level6Fragment() { // Required empty public constructor
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_level6, container, false);
    ...
    private void onNumberClick(int number, Button button) {
        if (number == currentNumber) {
            ...
            if (currentNumber > 10) {
                ...
                ((LevelsActivity) requireActivity()).delayFragment(7);
            }
        } else {
